...
// Vite Integration (Dev Mode) & Vercel Serverless Export
...
// Only start local listener when not running on Vercel serverless
if (!process.env.VERCEL) {
  app.listen(PORT, '0.0.0.0', () => {
    console.log(`Care AI Server running at http://0.0.0.0:${PORT}`);
  });
}
